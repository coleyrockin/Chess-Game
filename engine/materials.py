...
class CyberpunkMaterials:
    ...
    BOARD_LIGHT = MaterialDef((0.2, 0.28, 0.38), 0.58, 0.34, 0.95, (0.03, 0.04, 0.06))
    BOARD_DARK = MaterialDef((0.06, 0.09, 0.15), 0.52, 0.48, 0.9, (0.01, 0.01, 0.03))
    ...
    WHITE_PIECE = MaterialDef((0.93, 0.95, 0.98), 0.95, 0.09, 1.0, (0.1, 0.1, 0.12))
    BLACK_PIECE = MaterialDef((0.03, 0.04, 0.06), 0.8, 0.16, 0.98, (0.08, 0.03, 0.1))
